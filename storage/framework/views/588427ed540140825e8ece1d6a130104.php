...
<div class="card">
  ...
  <div class="card-body">
      ...
      <form action="<?php echo e(route('student.update',$students->id)); ?>" method="post">
        <?php echo csrf_field(); ?>
...
<?php echo $__env->make('students.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\orm laravel\project-ORM\resources\views/students/edit.blade.php ENDPATH**/ ?>